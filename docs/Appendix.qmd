...
In contrast to the patterns from the all-complete dataset, we found a positive effect of protection on bacterial richness and Shannon index in the bacteria-complete dataset, while effect size for dissimilarity was not significantly different from 0 (Appendix Table 4.1, Appendix Figure 4.2); the all-complete dataset showed the exact opposite pattern with less diverse and similar bacteria communities in protected areas. Higher richness and Shannon index in protected areas in the bacteria-complete dataset are also exactly opposite to the pattern we found at regional scale, indicating again that effects are not consistent across scales. However, we still found the mixed pattern of the effect of protection status on soil biodiversity, here specifically for bacteria, with no consistent direction but being positive and negative for different diversity aspects (i.e. richness, Shannon index, dissimilarity).

### Random-intercept model

Random-intercept models did not differ for the bacteria-complete and all-complete dataset regarding those protected area categories that are present in both (Appendix Table 4.2; Appendix Figure 4.4). For the categories being only present in the bacteria-complete dataset, we found similarly low bacterial richness and Shannon index as well as similarly high dissimilarity for protected sites of category Ib and VI; both align most with richness trends for protected sites of category V and otherwise did not differ from attribute values in other IUCN categories.
