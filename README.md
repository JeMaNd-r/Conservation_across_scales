...
- `PAtypes_Bayesian` and `pars_PAtypes_Bayesian_df` Results of the random-intercept models, either as estimated marginal means (`emmeans`), as subset of 10,000 randomly samples slope estimates (`sample10k`), or as model estimates `pars_PAtypes_Bayesian_df`.
